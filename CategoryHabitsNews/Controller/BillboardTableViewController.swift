...
class BillboardTableViewController: UITableViewController,SegementSlideContentScrollViewDelegate,XMLParserDelegate {
    ...
    override func viewDidLoad() {
        ...
        //XMLパース
        let urlString = "https://news.yahoo.co.jp/rss/media/exp/all.xml"
